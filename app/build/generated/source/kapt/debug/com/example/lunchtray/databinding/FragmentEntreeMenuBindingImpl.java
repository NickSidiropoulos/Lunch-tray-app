...
public class FragmentEntreeMenuBindingImpl extends FragmentEntreeMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        boolean viewModelMenuItemsPastaNameEqualsJavaLangStringPasta = false;
        boolean viewModelMenuItemsCauliflowerNameEqualsJavaLangStringCauliflower = false;
        ...
        boolean viewModelMenuItemsChiliNameEqualsJavaLangStringChili = false;
        ...
        boolean viewModelMenuItemsSkilletNameEqualsJavaLangStringSkillet = false;
        ...
        if ((dirtyFlags & 0xdL) != 0) {
            ...
            if ((dirtyFlags & 0xcL) != 0) {
                    ...
                    if (viewModelMenuItemsPastaName != null) {
                        // read viewModel.menuItems["pasta"].name.equals("pasta")
                        viewModelMenuItemsPastaNameEqualsJavaLangStringPasta = viewModelMenuItemsPastaName.equals("pasta");
                    }
                    if (viewModelMenuItemsCauliflowerName != null) {
                        // read viewModel.menuItems["cauliflower"].name.equals("cauliflower")
                        viewModelMenuItemsCauliflowerNameEqualsJavaLangStringCauliflower = viewModelMenuItemsCauliflowerName.equals("cauliflower");
                    }
                    if (viewModelMenuItemsSkilletName != null) {
                        // read viewModel.menuItems["skillet"].name.equals("skillet")
                        viewModelMenuItemsSkilletNameEqualsJavaLangStringSkillet = viewModelMenuItemsSkilletName.equals("skillet");
                    }
                    if (viewModelMenuItemsChiliName != null) {
                        // read viewModel.menuItems["chili"].name.equals("chili")
                        viewModelMenuItemsChiliNameEqualsJavaLangStringChili = viewModelMenuItemsChiliName.equals("chili");
                    }
            }
        }
        // batch finished
        ...
        if ((dirtyFlags & 0xcL) != 0) {
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.cauliflower, viewModelMenuItemsCauliflowerNameEqualsJavaLangStringCauliflower);
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.chili, viewModelMenuItemsChiliNameEqualsJavaLangStringChili);
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.pasta, viewModelMenuItemsPastaNameEqualsJavaLangStringPasta);
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.skillet, viewModelMenuItemsSkilletNameEqualsJavaLangStringSkillet);
