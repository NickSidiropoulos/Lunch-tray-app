...
public class FragmentAccompanimentMenuBindingImpl extends FragmentAccompanimentMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        boolean viewModelMenuItemsBerriesNameEqualsJavaLangStringBerries = false;
        ...
        boolean viewModelMenuItemsPicklesNameEqualsJavaLangStringPickles = false;
        ...
        boolean viewModelMenuItemsBreadNameEqualsJavaLangStringBread = false;
        ...
        if ((dirtyFlags & 0xdL) != 0) {
            ...
            if ((dirtyFlags & 0xcL) != 0) {
                    ...
                    if (viewModelMenuItemsBreadName != null) {
                        // read viewModel.menuItems["bread"].name.equals("bread")
                        viewModelMenuItemsBreadNameEqualsJavaLangStringBread = viewModelMenuItemsBreadName.equals("bread");
                    }
                    if (viewModelMenuItemsPicklesName != null) {
                        // read viewModel.menuItems["pickles"].name.equals("pickles")
                        viewModelMenuItemsPicklesNameEqualsJavaLangStringPickles = viewModelMenuItemsPicklesName.equals("pickles");
                    }
                    if (viewModelMenuItemsBerriesName != null) {
                        // read viewModel.menuItems["berries"].name.equals("berries")
                        viewModelMenuItemsBerriesNameEqualsJavaLangStringBerries = viewModelMenuItemsBerriesName.equals("berries");
                    }
            }
        }
        // batch finished
        if ((dirtyFlags & 0xcL) != 0) {
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.berries, viewModelMenuItemsBerriesNameEqualsJavaLangStringBerries);
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.bread, viewModelMenuItemsBreadNameEqualsJavaLangStringBread);
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.pickles, viewModelMenuItemsPicklesNameEqualsJavaLangStringPickles);
