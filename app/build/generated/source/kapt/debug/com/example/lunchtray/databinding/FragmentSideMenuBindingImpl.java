...
public class FragmentSideMenuBindingImpl extends FragmentSideMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        boolean viewModelMenuItemsPotatoesNameEqualsJavaLangStringPotatoes = false;
        boolean viewModelMenuItemsSaladNameEqualsJavaLangStringSalad = false;
        ...
        boolean viewModelMenuItemsRiceNameEqualsJavaLangStringRice = false;
        ...
        boolean viewModelMenuItemsSoupNameEqualsJavaLangStringSoup = false;
        ...
        if ((dirtyFlags & 0xdL) != 0) {
            ...
            if ((dirtyFlags & 0xcL) != 0) {
                    ...
                    if (viewModelMenuItemsSoupName != null) {
                        // read viewModel.menuItems["soup"].name.equals("soup")
                        viewModelMenuItemsSoupNameEqualsJavaLangStringSoup = viewModelMenuItemsSoupName.equals("soup");
                    }
                    if (viewModelMenuItemsPotatoesName != null) {
                        // read viewModel.menuItems["potatoes"].name.equals("potatoes")
                        viewModelMenuItemsPotatoesNameEqualsJavaLangStringPotatoes = viewModelMenuItemsPotatoesName.equals("potatoes");
                    }
                    if (viewModelMenuItemsSaladName != null) {
                        // read viewModel.menuItems["salad"].name.equals("salad")
                        viewModelMenuItemsSaladNameEqualsJavaLangStringSalad = viewModelMenuItemsSaladName.equals("salad");
                    }
                    if (viewModelMenuItemsRiceName != null) {
                        // read viewModel.menuItems["rice"].name.equals("rice")
                        viewModelMenuItemsRiceNameEqualsJavaLangStringRice = viewModelMenuItemsRiceName.equals("rice");
                    }
            }
        }
        // batch finished
        ...
        if ((dirtyFlags & 0xcL) != 0) {
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.potatoes, viewModelMenuItemsPotatoesNameEqualsJavaLangStringPotatoes);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.rice, viewModelMenuItemsRiceName);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.rice, viewModelMenuItemsRiceNameEqualsJavaLangStringRice);
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.salad, viewModelMenuItemsSaladNameEqualsJavaLangStringSalad);
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.soup, viewModelMenuItemsSoupNameEqualsJavaLangStringSoup);
